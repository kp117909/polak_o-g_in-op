                      ...
                      <form action="user_edit.php" method="post">
                        <div class="row">
                            <div class="bio-row">
                                ...
                                <input class="form-control" name="inputFirstName" id="inputFirstName" type="text" placeholder="Wprowadź Imię" value="<?php echo $_SESSION['first_name'];?>">
                            </div>
                            <div class="bio-row">
                                <label class="small mb-1" for="inputLastName">Nazwisko</label>
                                <input class="form-control" name="inputLastName" id="inputLastName" type="text" placeholder="Wprowadź Nazwisko" value="<?php echo $_SESSION['last_name'];?>">
                            </div>
                            <div class="bio-row">
                            <label class="small mb-1" for="inputEmail">Email</label>
                                <input class="form-control" name="inputEmail" id="inputEmail" type="text" placeholder="Wprowadź Email" value="<?php echo $_SESSION['email'];?>" disabled>
                            </div>
                            <div class="bio-row">
                            <label class="small mb-1" for="inputPhone">Numer Telefonu</label>
                                <input class="form-control" name = "inputPhone" id="inputPhone" type="text" placeholder="Wprowadź Numer Telefonu" value="<?php echo $_SESSION['phonenumber'];?>">
                            </div>
                            <div class="bio-row">
                            <label class="small mb-1" for="city">Miasto</label>
                                <input class="form-control" name = "city" id="city" type="text" placeholder="Wprowadź Miasto" value="<?php echo $_SESSION['city'];?>">
                            </div>
                            <div class="bio-row">
                            <label class="small mb-1" for="address">Adres</label>
                                <input class="form-control" name = "address" id="address" type="text" placeholder="Wprowadź Adres" value="<?php echo $_SESSION['address'];?>">
                            </div>
                            <div class="bio-row">
                            <label class="small mb-1" for="nr_zamieszkania">Numer Lokalu</label>
                                <input class="form-control" name = "nr_zamieszkania" id="nr_zamieszkania" type="text" placeholder="Wprowadź Numer Lokalu" value="<?php echo $_SESSION['nr_zamieszkania'];?>">
                            </div>
                        </div>
